...
In this lecture we prove the equivalence of several definitions of Alexandrov space.
...
Show that $\EE^2$-comparison holds for any quadruple $q$, $y_1$, $y_2$, $y_3$ such that
...
The first statement in the last exercise is called \index{angle-sidelength monotonicity}\emph{angle-sidelength monotonicity}.
...
One could define Alexandrov space as a complete \textit{length} space with curvature $\ge \kappa$.
