...
Show that there is a unique geodesic $[xz]$ and $[xz]\subset [xy]$.
\end{thm}
...
\item For any $t_0\in \II$ there is a quadratic polynomial $\ell$ (it is called a \index{local barrier}\emph{local barrier}) that locally supports $s$ at $t_0$ from above;
