...
Observe that $(\tilde r^2)''\equiv2$; also \ref{eq:r=<r} implies the Jensen inequality for the function $h\:t\mapsto r(t)^2-t^2$.
Since the subinterval $[t_0,t_1]$ can be chosen arbitrarily, we conclude that $h$ is concave, and the proposition follows.
\qeds
