...
\parit{\ref{SHORT.ex:oplus:b}.} Suppose $\gamma$ is a rectifiable curve with the endpoints in $A$.
Show and use that the curve $\bar\gamma=\proj_A\circ\gamma$ has the same endpoints and
\[\length\bar\gamma\le \length\gamma;\]
moreover, in case of equality $\gamma$ lies in $A$.
