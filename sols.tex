...
Without assuming that all $A_i$ are contained in a compact subset of $\spc{X}$ the statement is false as can be seen by the example of $\space{X}=\RR, A_n=\{0,n\}, A_\infty=\{0\}$.
...
Let $\iota_n\:\spc{A}\to \lambda_n\cdot \spc{A}$ be the rescaling maps.
...
Apply the dilation map from the proof of the Bishop–Gromov inequality (\ref{inq:BG} and \ref{ex:BG}).
