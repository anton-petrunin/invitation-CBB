...
Argue as in \ref{thm:gromov-compactness} to construct a Gromov--Hausdorff convergence of $\cBall(p_n,R)_{\spc{A}_n}$ for a given $R>0$, then apply the diagonal procedure to construct the needed convergence.
...
Choose a smooth upper barrier $\bar f$ of $f$ at $t_0$ with $\bar f''\le \lambda_1$, provided by the lemma.
