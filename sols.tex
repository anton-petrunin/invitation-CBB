...
By the angle comparison, the angles adjacent to polygonal sides of $\tilde\Lambda$ do not exceed $\beta$ and $\gamma$.
It follows that
\[\area\tilde\Lambda-\area\tilde\Delta\le \tfrac12\cdot(\beta+\gamma-\tilde\beta-\tilde\gamma)\cdot \diam^2 \Delta.\]
Therefore
\[\area\Delta-\area\tilde\Delta\le \tfrac12\cdot\excess\Delta\cdot \diam^2 \Delta+\eps\]
