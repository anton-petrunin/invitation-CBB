...
In particular, we can identify isometrically $\T_p\spc{A}$ with $\T_{\iota_n(p)}\spc{A}_n$.
...
By the assumption, we can choose a point $z$ on the extension of $[pq]$ behind~$q$.
