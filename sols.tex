...
\parbf{\ref{ex:tangent=Em}}; \ref{SHORT.ex:tangent=Em:a}.
...
\parit{\ref{SHORT.ex:tangent=Em:b}.}
Assume that $k=k(p)<m$ for some $p\in \spc{A}^\circ$.
Apply \ref{inq:BG:a} to show that $\HausDim\spc{A}\le k$.
Apply \ref{thm:dim=dim} and arrive at a contradiction.
