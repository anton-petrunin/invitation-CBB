...
Note that by an degree argument the maps $g_n$ and $h_n$ are onto.
...
\footnote{\red V: I don't think there should be $\cdot \dist{p}{x_i}{S}$ in this formula}
Note that this family is not necessarily continuous.
