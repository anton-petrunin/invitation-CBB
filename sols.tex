...
$\dist{x}{y}{\spc{X}}=\pi$. Conclude that $\diam \spc{X}\z\le \pi$.
...
\parbf{\ref{ex:surface-covergence}.} We will use that the nearest-point projection $x\mapsto \bar x$ from the Euclidean space $\EE^m$  to a convex body is short; that is, distance-nonexpanding (see for example \cite[13.3]{petrunin-zamora}).
