...
\parbf{\ref{ex:compact-GH}.}
The first part follows straight from the definitions.
For the second part, show and use that there is a convergence of the constant sequence $\spc{X}_\infty$ to $\spc{X}_\infty'$.
