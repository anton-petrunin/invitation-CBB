...
It follows that we can choose $N+1$ directions in $\Sigma_p$ at anles leger that $\eps$ from each other.
...
Further, apply \ref{thm:dim=dim} to show that $\LinDim\T_p\ge\LinDim\spc{A}$.
