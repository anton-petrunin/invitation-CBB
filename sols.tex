...
We can assumme that $f(p)=0$ and $f$ is $1$-concave.
...
We will use that the nearest-point projection from the Euclidean space to a convex body is short;
...
This statement is a partial case of the theorem about extremal subsets proved by the third author \cite[1.2]{petrunin1997}.

\parbf{\ref{ex:alexandrov=<4}.}
\ref{SHORT.ex:alexandrov=<4:>=3}. Observe that curvature of any essential vertex is less than $2\cdot\pi$ and apply the Gauss--Bonnet formula \ref{ex:gauss-bonnet}.
