...
Namely, if $|(f\circ\gamma)^\pm|$ is bounded away from zero for a geodesic $\gamma$, then $\phi\circ f\circ\gamma$ can be made as concave as you wish by choosing an appropriate $\phi$.
...
Suppose $p,a_0,\dots,a_m$ are points in an $m$-dimensional Alexandrov space $\spc{A}$ such that $\dist{p}{a_i}{}=r$ for any $i$ and $\angk p{a_i}{a_j}>\tfrac\pi2$
for any $i\ne j$.
Let $\phi_{c,r}$ be as in the proof of \ref{thm:strictly-concave}, with $c$ large.
