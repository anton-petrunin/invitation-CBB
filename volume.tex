...
Construct an Alexandrov space $\spc{A}$ such that there is no open set $\Omega\subset \spc{A}$ with a strictly concave function $f$ defined on $\Omega$.
\end{thm}
...
for any $i\ne j$, and let $\phi_{c,r}$ be as in the proof of \ref{thm:strictly-concave}, with $c$ large.
