...
Namely, if $|(f\z\circ\gamma)^\pm|$ is bounded away from zero for a geodesic $\gamma$, then $\phi\circ f\circ\gamma$ can be made as concave as you wish by choosing an appropriate $\phi$.
