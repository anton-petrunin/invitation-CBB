...
This lecture discusses applications of Alexandrov geometry that come from the survival of the curvature bound
under a Gromov--Hausdorff limit.
...
Further, we use all this to prove the homotopy stability theorem (\ref{thm:h-stability}) and the homotopy finiteness theorem (\ref{thm:h-finiteness}).
...
Recall that $\GH$ denotes the space of compact metric spaces equipped with with the Gromov--Hausdorff metric; see Section~\ref{sec:Gromov--Hausdorff-metric}.
