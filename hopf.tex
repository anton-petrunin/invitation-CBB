...
Let $\spc{L}$ be a complete finite-dimensional $\Alex1$ space with nonempty boundary $\partial\spc{L}$.
Show that $\partial\spc{L}$ is connected.
\end{thm}


\begin{thm}{Exercise}\label{ex:dist-to-bry}
Let $\spc{L}$ be a complete finite-dimensional $\Alex0$ space with nonempty boundary $\partial\spc{L}$.
