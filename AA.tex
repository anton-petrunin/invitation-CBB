...
that $\gamma$ can cross the common boundary of two halves $\spc{L}_0$ $\spc{L}_1$ of $\spc{W}$ at most once, or it lies in the common boundary.
...
Since $\nabla_x f\in \T_x\partial\spc{L}$, we have 
