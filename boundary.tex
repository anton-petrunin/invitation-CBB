...
We are going to the following result without proof;
it is close relative of Perelman's stability theorem \ref{thm:stability}, and it is proved in \cite{perelman1993}.
...
The following theorem states that boundary is a topological invariant, despite our definition heavily used geometry.
...
Let us discuss several additional tools that available for spaced with empty boundary.
...
The Morse lemma was originally proved by Grigory Perelman \cite{perelman1993} for special kind of semiconcave functions made out of distance functions.
