...
The following theorem states that even though our definition relies heavily on geometry, boundary is a topological invariant.
...
Since $x,y\in \partial \spc{A}$, the arc of $\hat\gamma$ beyond $y$ lies in the image of map $t\mapsto \GF^t_{f_x}(y)$, where $f_x=\tfrac12\cdot\distfun^2_x$.
...
Consider the curve $\alpha(s)\df\gexp_x(s\cdot\xi')$.
Let us show that 
\[
\begin{aligned}
\dist{p}{z}{\spc{W}}
