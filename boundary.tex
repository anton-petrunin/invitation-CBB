...
It seems to be unknown whether it must be homeomorphic to a CW complex, but it is known that every Alexandrov space is a CS set; the latter was prved by Tadashi Fujioka \cite{fujioka2025a}.
