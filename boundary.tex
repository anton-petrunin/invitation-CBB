...
\footnote{\red V: I already made that comment but  tangent spaces have already been defined in chapter 4. }


We for a point $p\in \partial  \spc{A}$ we define $\Sigma_p(\partial\spc{A})$ and $T_p(\partial\spc{A})$ similarly by requiring $x_n\in \spc{A}$ in the above definition.
...
The following statement \footnote{\red  add reference?} plays a technical role in the proof of stability theorem,
