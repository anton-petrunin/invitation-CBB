...
However, the tangent space $\T_p$ might fail to be geodesic; see  Halbeisen's example \cite{alexander-kapovitch-petrunin-2025}.
...
\begin{subthm}{}
The tangent space $\T_p$ is proper.
\end{subthm}
...
Here $\TopDim$ and $\HausDim$ stands for \emph{Lebesgue coverning dimension} and \emph{Hausdorff dimension}, respectively.
...
Halbeisen's example \cite{alexander-kapovitch-petrunin-2025,halbeisen} shows that compactness of space of directions is essential in the proof that space of directions is $\pi$-geodesic (see \ref{thm:finite-space-of-directions}).
