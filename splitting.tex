...
In this lecture, we prove the line splitting theorem and apply it to study tangent spaces on an Alexandrov space.
...
A metric space $\spc{X}$ is a \index{direct sum}\emph{direct sum} of its two  subsets $A$ and $B$,
or briefly,
...
Also, we introduce volume and prove the Bishop--Gromov inequality, the right-inverse theorem and introduce distance charts in finite-dimensional Alexandrov spaces.
...
For instance, any geodesic space is $\infty$-geodesic. \footnote{\red V: perhaps move this definition to the preliminaries?}
