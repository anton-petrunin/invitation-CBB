...
We refer to \cite{hurewicz-wallman} for definitions of \index{Lebesgue coverning dimension}\emph{Lebesgue coverning dimension} \index{$\TopDim$}$\TopDim$ and \index{Hausdorff!dimension}\emph{Hausdorff dimension}\index{$\HausDim$}$\HausDim$.
...
\footnote{\red V: either something should be said here about the infinite dimensional case (it is now only in the comments) or the finite dimensional assumption added.}
\qedsf
