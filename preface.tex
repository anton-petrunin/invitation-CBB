...
This subject is more technical and takes more preparation, so we had to skip several proofs.
...
All of them are solved at the end of the book; in each case.
...
Further, we introduce and study linear subspaces of tangent spaces.
...
\begin{itemize}
\item The first introduction to Alexandrov geometry of all dimensions is given in the original paper by Yuriy Burago, Michael Gromov, and Grigory Perelman \cite{burago-gromov-perelman} and its extension \cite{perelman1991} written by Perelman.
