...
This subject is more technical; it takes more preparation, and we had to skip several proofs.
...
In Lecture~\ref{chap:globalization}, we formulate and prove the globalization theorem that the local Alexandrov condition implies global.
...
Exercises that are used in the sequel are marked with an exclamation point: \textbf{Exercise!}
