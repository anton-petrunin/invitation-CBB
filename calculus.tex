...
Let $f$ be a semiconcave function defined in a neighborhood of a point $p$ in an Alexandrov space $\spc{A}$ (recall that all our functions are locally Lipschitz).
...
Here we assume that all functions $f_1$, $f_2,\dots$ are semiconcave and Lipschitz near $p$.
\end{thm}
