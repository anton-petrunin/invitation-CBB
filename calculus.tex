...
Next we define a multiplication by scalar, scalar product, norm, and angle on Euclidean cones, extending the usual definitions from Euclidean space.
...
The \index{angle measure}\emph{angle measure} \index{31@$\mangle$ (angle measure)} $\mangle(v,w)$ and \index{32@$\<v,w\>$ (scalar product)} \index{scalar product}\emph{scalar product} $\<v,w\>$
