...
This lecture introduce several notions related to the first-order derivatives in Alexandrov spaces, including spaces of directions, tangent spaces, differentials, and gradients.
...
The point $v$ in $\spc{V}$ that corresponds $(t,x)\z\in[0,\infty)\times \spc{X}$ will be denoted by \index{33@$r\cdot u$ (multiplication in cone)}$t\cdot x$;
the space $\spc{X}$ might be identified with the unit sphere in $\spc{V}$; so $x=1\cdot x$.
More genrally, for $v,w\in \spc{V}$, we will write $w=s\cdot v$ if $v$ corresponds to $(t,x)\z\in[0,\infty)\times \spc{X}$ and $w$ corresponds to $(s\cdot t,x)\z\in[0,\infty)\times \spc{X}$.
...
Moreover, the convergence can be choosen so that for any geodesic $\gamma$ that starts at $p$, we have
