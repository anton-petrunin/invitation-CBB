...
Let $f$ be a semiconcave function defined in a neigborhood of a point $p$ in an Alexandrov space $\spc{A}$ (recall that all our functions are locally Lipschitz).
...
Existence of $\overline{\xi}$ is obvious if $ \Sigma_p$ is comapct.
