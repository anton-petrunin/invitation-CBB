...
Next we define a scalar product, norm, and angle on Euclidean cones, extending the usual definitions from Euclidean space.

The point in $\spc{V}$ that corresponds $(t,x)\z\in[0,\infty)\times \spc{X}$ will be denoted by \index{33@$r\cdot u$ (multiplication in cone)}$t\cdot x$.
