...
The \index{angle measure}\emph{angle measure} \index{31@$\mangle(v,w)$ (angle measure)} $\mangle(v,w)$ and \index{32@$\<v,w\>$ (scalar product)} \index{scalar product}\emph{scalar product} $\<v,w\>$
