...
The following definition generalizes the notion of gradients of smooth functions to semiconcave functions on Alexandrov spaces.
...
\vskip0mm
\end{wrapfigure}
%the picture was overlapping the text so I shifted it up
