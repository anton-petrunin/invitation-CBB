...
This lecture defines several notions related to the first-order derivatives in Alexandrov spaces, including spaces of directions, tangent spaces, differentials, and gradients.
...
From the point-on-side (\ref{point-on-side}), we have
\[\angk{v_t}p{w_t}
\ge
\angk{v_t}p{u_t}
=
