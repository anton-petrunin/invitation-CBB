...
Applying several results in differential topology,\footnote{\red A: Vitya could you give refs? V" for $dim\ge 5$ this is proved in the book by Kirby and  Siebenmann "Foundational Essays on Topological Manifolds, Smoothings and Triangulations". For $n\le 3$ I don't actually know a concise  reference. It follows from a combination of several results (Moise's theorem that top manifolds of $\dim\le 3$ are triangulable and separate theorems in dimensions 2 and 3 that PL maniolfds in those dimensions admit unique smooth structures. The last statement is proved in Thurston's book "Three-dimensional geometry and topology". But I am not sure it makes sense to go into all these details. I would probably just cite Kirby-Siebenmann for $n\ge 5$ and Moise and Thurston for $n \le 3$} this statement can be improved to diffeomorphism-type finiteness in all dimensions except 4.
