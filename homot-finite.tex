...
Artem Nepechiy proved existence of $2$-convex function in a neighborhood of a point $p$ in Alexandrov space that that approximates $\distfun_p^2$ up to second order \cite{nepechiy2019}.
