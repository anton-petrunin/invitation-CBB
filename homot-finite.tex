...
While Alexandrov spaces have plenty of semiconcave functions (for example $\distfun_p^2$), 
...
Let $\spc{L}_1,\spc{L}_2,\dots,\spc{L}_\infty$ be a sequence of $m$-dimensional Alexandrov spaces with curvature $\ge \kappa$, and $m<\infty$.
...
There are only finitely many homotopy types of $m$-dimensional Alexandrov spaces with curvature $\ge\kappa$, diameter $\le D$, and volume $\ge v_0$;
