...
Construct an Alexandrov space $\spc{L}$ such that there is no strictly concave function with an open domain of definition in $\spc{L}$.
\end{thm}


\section{Liftings}

Suppose that the Gromov--Haudorff distance $\dist{\spc{L}}{\spc{L}'}{\GH}$ is sufficiently small, so we may think that both spaces $\spc{L}$ and $\spc{L}'$ lie at a small Hausdorff distance in an ambient metric space $\spc{W}$.
...
Let $\spc{L}_1,\spc{L}_2,\dots$, and $\spc{L}_\infty$ be compact $m$-dimensional $\Alex\kappa$ spaces, and $m<\infty$.
Suppose $\spc{L}_n\z\to \spc{L}_\infty$ as $n\to \infty$ in the sense of Gromov--Hausdorff.
...
By Gromov's selection theorem, we can assume that $\spc{L}_n$ converges to say $\spc{L}_\infty$ in the sense of Gromov--Hausdorff.
...
Let $\spc{L}_1,\spc{L}_2,\dots$, and $\spc{L}_\infty$ be compact $m$-dimensional $\Alex\kappa$ spaces, and $m<\infty$.
Suppose $\spc{L}_n\to \spc{L}_\infty$ as $n\to \infty$ in the sense of Gromov--Hausdorff.
