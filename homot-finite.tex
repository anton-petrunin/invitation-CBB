...
It is expected that some Alexandrov spaces are not Gromov--Hausdorff limit of Riemannian manifolds with a fixed lower curvature bound; see \cite{kapovitch2005} for some partial results in this direction.

In principle, the same strategy might work for a sequence of Riemannian manifolds with dimension approaching infinity.
