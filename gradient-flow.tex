...
Here we define the gradient flows of semiconcave  functions on Alexandrov spaces and prove important distance estimates.
...
The gradient exponential map in a Riemannian manifold $(M,g)$ coincides with the Riemannian exponential map inside the cut locus, but \textit{is different} from the  Riemannian exponential after that.  Moreover, beyond the cut locus $\gexp_p^\kappa$ depends on $\kappa$ while the Riemannian exponential map does not.
