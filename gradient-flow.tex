...
for any geodesic path $\gamma$ that starts at $p$ and $\dist{\gexp_p^{1}v}{\gexp_p^{1}w}{\spc{L}}\le \side\hinge0vw_{\SSS^2}$, but this time all this holds only if $|v|,|w|\le\tfrac\pi2$ and $\length\gamma\le\pi$.
