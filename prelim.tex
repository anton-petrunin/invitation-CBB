...
\end{itemize}
All these topics are treated in detail in the classic book of Dmitri Burago, Yurii Burago, and Sergei Ivanov \cite{burago-burago-ivanov}; see also a short book of the third author \cite{petrunin2023pure}.
...
Given small $\eps>0$, for all sufficiently small $t,\tau,s\in[0,\infty)$ we have
\begin{align*}
...
Loosely speaking, the distance between (isometry classes of) compact metric spaces will be defined as the minimal value $r$ such that  both spaces can be isometrically embedded into a third space in  such a way that the Hausdorff distance between the images is not greater than $r$.
