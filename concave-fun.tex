...
Tangent spaces of an Alexandrov space are spaces with nonnegative curvature in the sense of Alexandrov.
\end{thm}
...
Let $f$ be a \emph{distance function} on an Alexandrov space $\spc{L}$ with nonnegative curvature;
