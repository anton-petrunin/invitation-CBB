...
Recall that \index{cone}\emph{Euclidean cone} $\spc{V}=\Cone\spc{X}$ 
...
Recall that $\lambda$-concave functions are defined in Section \ref{Function comparison}.
...
otherwise, $\nabla_pf=s\cdot \overline{\xi}$, where 
$s= \dd_pf(\overline{\xi})$
and
