...
The Bishop--Gromov inequality was originally proved for Riemannian manifolds with lower Ricci curvature.
The first statement is called \emph{Bishop's inequality}.
It is due to Richard Bishop; see \cite{bishop1964} and \cite[Corollary 4, p. 256]{bishop-crittenden}.
Sometimes it is called \emph{Bishop's inequality}.
The second statement is due to Michael Gromov \cite{gromov1981}.
