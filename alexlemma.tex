...
A complete geodesic space $\spc{L}$ in $\Alex0$ if and only if $f''\le 1$ for any function $f$ of the form 
...
Also, by Plaut's theorem, any point $p$ in $\spc{L}$ can be connected by geodesics to \textit{most} of points in $\spc{L}$
