...
holds, then we say that the quadruple meets \index{$\EE^2$-comparison}\emph{$\EE^2$-comparison}.

If instead of $\EE^2$, we use $\SSS^2$ or $\HH^2$, then we get the definition of
\index{$\SSS^2$-comparison}\index{$\HH^2$-comparison} $\SSS^2$- or $\HH^2$-comparisons.
...
This way we define \index{$\MM^2(\kappa)$-comparison}$\MM^2(\kappa)$-comparison for any real $\kappa$.
...
If a complete geodesic space has curvature $\ge\kappa$ in the sense of Alexandrov for some $\kappa$, 
then it will be called \index{Alexandrov space}\emph{Alexandrov space}.
\end{thm}

\begin{thm}{Exercise}\label{ex:Euclid-is-CBB}
Show that $\EE^n$ has nonnegative curvature in the sense of Alexandrov.
\end{thm}
...
If $p,x,y,z$ are points in a 
space with nonnegative curvature in the sense of Alexandrov.
...
Let $\hinge p x y$ be a hinge in a 
space with nonnegative curvature in the sense of Alexandrov.
...
For any hinge $\hinge p x y$ in a 
space with nonnegative curvature in the sense of Alexandrov,
...
Let $\hinge pxz$ and $\hinge pyz$ be adjacent hinges in a 
space with nonnegative curvature in the sense of Alexandrov.
Show that
...
Let $\hinge pxy$ be a hinge in a 
space $\spc{L}$ with nonnegative curvature in the sense of Alexandrov.
...
A geodesic space $\spc{L}$ has nonnegative curvature in the sense of Alexandrov if the following conditions hold.
...
\begin{subthm}{cbb}
$\spc{L}$ has nonnegative curvature in the sense of Alexandrov.
\end{subthm}
...
Construct a geodesic space $\spc{X}$ does not have nonnegative curvature in the sense of Alexandrov, but satisfies the following condition: for any three points $p,x,y\in \spc{X}$ there is a geodesic $[x y]$ such that for any $z\in \left]x y\right[$
...
Suppose that $\spc{W}$ has nonnegative curvature in the sense of Alexandrov.
...
if one (and therefore any) of them hold for $s$, then we say that $s$ is \index{$\lambda$-concave function}\emph{$\lambda$-concave}.
\begin{itemize}
...
A geodesic space $\spc{L}$ has nonnegative curvature in the sense of Alexandrov if and only if $f''\le 1$ for any function $f$ of the following type 
...
For example, the function comparison for curvature $\ge-1$ states that 
...
Similarly, the function comparison curvature $\ge1$ states that for any point $p$, we have
