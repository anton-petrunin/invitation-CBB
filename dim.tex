...
%should it say locally Lipschitz here for consistency?
 defined in an open set $\Dom f$ in a finite-dimensional Alexandrov space.
...
is continuous (in fact Hölder) in $\Omega=\oBall(f(p),\tfrac{\eps^2}{2}\cdot r)\subset\RR^m$
