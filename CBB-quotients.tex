...
\footnote{ \red V: do you want to give some kind of hint here? }
\end{thm}
...
It's easy to see that \ref{thm:extr-point} implies the bound in $|F|\le2^m$ in \ref{erdos-problem} by taking $\spc{A}$ to be the convex hull of $F$.
\footnote{ \red V; does the rigidity case follow from this?}
