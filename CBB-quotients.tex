...
Show that the inverse image $T(r)$ of $S(r)$ in $\SSS^3$ is an orbit of the torus action.
...
\parit{Remark.}
Applying the above argument to the convex hull of $F$ in \ref{erdos-problem} proves that $|F|\le 2^m$;
...
Crude estimates on number of extremal subsets follow from the idea in Gromov's Betti number theorem \ref{thm:betti}.
