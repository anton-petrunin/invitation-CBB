...
so \ref{thm:hsiang-kleiner} holds for a general $\Alex1$ space.
...
The extremal subsets of Alexandrov spaces were briefly discussed in \ref{sec:bry-remarks}.
...
Some crude estimates on the number of extremal subsets follow from the idea in Gromov's Betti number theorem \ref{thm:betti}.
