...
%\footnote{ \red V: do you want to give some kind of hint here? there is a hint at the end.}
\end{thm}
...
\footnote{{\red V; does the rigidity case follow from this?} Maybe move this phrase to the section with remarks --- the equality case is discussed there.}
