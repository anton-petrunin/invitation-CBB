...
Otherwise note that the sequence $r_n=\dist{p}{x_n}{}+\dist{x_n}{q}{}$ is nonincreasing, and $r_n\ge\tfrac{2}{3}\cdot\ell$ for all $n$. Then $\eps_n=r_n-r_{n+1}\to 0$.
By construction, the distances
$\dist{x_n}{x_{n+1}}{}$, $\dist{x_n}{p}{}$, and $\dist{x_n}{q}{}$ are bounded away from zero for all large $n$.

Indeed, from \ref{eq:thm:=def-loc-two-sided*} and  \ref{3|xx'|} it easily follows that $\dist{x_n}{x_{n+1}}{}\ge \ell/200$ for all large $n$.

We claim the the same lower bound holds for  $\dist{x_n}{p}{}$, and $\dist{x_n}{q}{}$ for all large $n$. Fix $n_0$ such that $\eps_n<l/1000$ for all  $n\ge n_0$.

Suppose for some $n\ge n_0$ it holds that $\dist{x_n}{p}{}\ge \ell/200$ and $\dist{x_n}{q}{}\ge \ell/200$. We want to show that the same lower bound holds for $x_{n+1}$. 

Without loss of generality we can assume that $ \dist{x_n}{p}{}\le  \dist{x_n}{q}{}$. Set $x=x_n, x'=x_{n+1}$.
...
A similar  argument shows that we can find an arbitrary large $n$ such that $\dist{x_n}{p}{}\ge \ell/200$ and $\dist{x_n}{q}{}\ge \ell/200$.
