...
Recall that a \index{length space}\emph{length space} is a metric space such that any two points $p$ and $q$ can be connected by a path with a length arbitrarily close to $|p-q|$.
...
I took the proof from our book \cite{alexander-kapovitch-petrunin-2025} (with generality reduction).
