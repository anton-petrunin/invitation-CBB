...
A metric space $\spc{L}$ is \index{locally nonnegative curvature}\emph{locally nonnegative curvature} in the sense of Alexandrov if any point $p\in\spc{L}$ admits a neighborhood $U\ni p$ such that the $\EE^2$-comparison holds for any quadruple of points in $U$.

\begin{thm}{Globalization theorem}\label{thm:glob} 
Let $\spc{L}$ be a compact geodesic space.
If $\spc{L}$ has locally nonnegative curvature in the sense of Alexandrov
then it has nonnegative curvature in the sense of Alexandrov.
\end{thm}
...
Let $\spc{L}$ be a geodesic space with locally nonnegative curvature in the sense of Alexandrov. 
...
It follows that a space with curvature $\ge \Kappa$ in the sense of Alexandrov space has curvature $\ge \kappa$, but  \textit{only locally}.
Therefore, the globalization theorem  imply the following.

\begin{thm}{Claim}\label{clm:K>k}
Suppose $\Kappa>\kappa$, then any geodesic space with curvature $\ge \Kappa$ in the sense of Alexandrov has curvature $\ge \kappa$ in the sense of Alexandrov.
\end{thm}
...
Let $\spc{L}$ be a geodesic space with curvature $\ge 1$,
and let $p$ and $q$ be points in $\spc{L}$.
Suppose $\dist{p}{q}{}>\pi$.
...
Suppose  
$\spc{L}$ is an Alexandrov space with curvature $\ge 1$
...
\begin{thm}{Theorem}\label{thm:noncomplete-globalization}
