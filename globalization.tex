...
The proof uses the following statement, assuming that $r(x)$ is the maximal radius of the ball centered at $x$ in which the comparison holds; see \cite[2F]{alexander-kapovitch-petrunin2024}.
...
For example,
let $\spc{X}$ be the set $\{p,x_1,x_2,x_3\}$ with the metric defined by $\dist{p}{x_i}{}=\pi$ and $\dist{x_i}{x_j}{}=2\cdot\pi$
for all $i\ne j$.
