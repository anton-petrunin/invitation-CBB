...
Note that condition \ref{angle-b} holds in $\spc{A}$ (necessity of \ref{angle-b} uses only the local condition).
...
Since $a_n+b_n=r_n<\ell$ and $a_n\le b_n$ it holds that $a_n\le \tfrac12\cdot\ell$.
Hence
\[
