...
\end{thm}
Alternatively this can be shown by approximating the defining convex function of a convex body  by a smooth convex function using a convolution. The Gauss formula implies that the level sets of the latter have $\sec\ge 0$ and hence are s $\Alex0$. Now the result again follows by \ref{ex:surface-covergence}.
