...
A \index{polyhedral surface}\emph{polyhedral surface} is defined as a 2-dimensional manifold (possibly with boundary) equipped with a length metric that admits a finite triangulation, where each triangle is isometric to a Euclidean triangle.
