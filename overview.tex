...
the remaining cases can be handled by approximation.
...
Alternatively, use that near an interior point the surface is locally isometric to a cone over a circle of length $\le 2\pi$ and near a boundary point it is locally isometric to the cone over an interval of length $\le \pi$. Apply \ref{ex:cone-CBB} and globalization.
...
Alternatively this can be shown by approximating the defining convex function of a convex body  by a smooth convex function using a convolution.
The Gauss formula implies that the level sets of the latter have $\sec\ge 0$ and hence are s $\Alex0$.
