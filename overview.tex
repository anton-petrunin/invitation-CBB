...
Note that acording to our definition, any polyhedral surface is closed.
...
The value $2\cdot\pi-\theta_p$ is called \emph{curvature} at $p$.
...
Show that the sum of curvatures of a closed polyhedral surface $\spc{P}$ equals $2\cdot\pi\cdot\chi(\spc{P})$,
