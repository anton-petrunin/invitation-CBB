...
A \index{polyhedral surface}\emph{polyhedral surface} is defined as a 2-dimensional manifold (possibly with boundary) equipped with a length metric such that there is a finite triangulation in which each triangle isometric to a Euclidean triangle.
