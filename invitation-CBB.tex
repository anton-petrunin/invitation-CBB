...
\def\thetitle{A journey into Alexandrov geometry: curvature bounded below}
...
\frontmatter
\title{A journey into Alexandrov geometry:\\ curvature bounded below}
...
\end{document}
%??? locally Lipschitz (usually or always)???
